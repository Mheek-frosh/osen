...
export default function Home(){
  ...
  return <>
    ...
    <section className="products section-pad"><div className="section-head"><div><p className="eyebrow">Freshly arrived</p><h2>New signatures</h2></div><Link className="mini-link" to="/shop">View all →</Link></div><ProductGrid items={featuredProducts}/><Link className="under-link" to="/shop">View all pieces <span>→</span></Link></section>
