...
export default function Home(){
  return <>
    <section className="hero"><img src="/assets/osen-hero.png" alt="Osen' Luxe model in an Ankara evening dress"/><div className="hero-copy"><p className="eyebrow">Elegant · Heritage · Luxury</p><h1>Rooted in craft.<br/><em>Made for now.</em></h1><p className="hero-sub">African fabrics, refined accessories, and memorable pieces shaped in Abuja.</p><Link className="btn btn-dark" to="/shop">Shop the collection <ArrowUpRight/></Link></div><p className="hero-index">01 / 03</p></section>
